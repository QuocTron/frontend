export const LogoInstagram = ({ width = '10.3rem', height = '2.9rem', className }) => (
    <svg
        ariaLabel="Instagram"
        className={className}
        color="#262626"
...
export const IconArrowDown = ({ width = '1.2rem', height = '1.2rem', className }) => (
    <svg
        ariLabel="Icono de comilla angular hacia abajo"
        className={className}
        color="#262626"
        fill="#262626"
        height={height}
...
export const IconHome = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Home"
        className={className}
        color="#262626"
...
export const IconHomeActive = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        ariLabel="Inicio"
        className={className}
        color="#262626"
...
export const IconMessage = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        ariLabel="Messenger"
        className={className}
        color="#262626"
...
export const IconMessageActive = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconUploadActive = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="New post"
        className={className}
        color="#262626"
...
export const IconCompass = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconCompassActive = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconHeart = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconHeartActive = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconHeartHover = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Like"
        className={className}
        color="#8e8e8e"
...
export const IconSearch = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        ariaLabel="Buscar"
        className={className}
        color="#8e8e8e"
...
export const IconUser = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        aria-label="Profile"
        className={className}
        color="#262626"
...
export const IconSave = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        aria-label="Saved"
        className={className}
        color="#262626"
...
export const IconSetting = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
        aria-label="Settings"
        className={className}
        color="#262626"
...
export const IconSync = ({ width = '1.6rem', height = '1.6rem', className }) => (
    <svg
...
export const IconUploadMedia = ({ width = '9.6rem', height = '7.7rem', className }) => (
    <svg
...
export const IconClose = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        width={width}
        height={height}
        className={className}
...
"
    >
        <path d="M18 6L6 18" stroke="#2e2e2e" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
        <path d="M6 6L18 18" stroke="#2e2e2e" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
    </svg>
);

export const IconThreeDot = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconComment = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Comment"
        className={className}
        color="#262626"
...
export const IconCommentHover = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Comment"
        className={className}
        color="#8e8e8e"
...
export const IconSharePost = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
...
export const IconSharePostHover = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Share Post"
        className={className}
        color="#8e8e8e"
...
export const IconSavePost = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Save"
        className={className}
        color="#262626"
...
export const IconSavePostHover = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Save"
        className={className}
        color="#8e8e8e"
...
export const IconLikeCommentHover = ({ width = '1.2rem', height = '1.2rem', className }) => (
    <svg
        aria-label="Like"
        className={className}
        color="#8e8e8e"
...
export const IconLikeComment = ({ width = '1.2rem', height = '1.2rem', className }) => (
    <svg
        aria-label="Like"
        className={className}
        color="#262626"
...
export const IconLikedPost = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Unlike"
        className={className}
        color="#ed4956"
...
export const IconSmileFace = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        aria-label="Emoji"
        className={className}
        color="#262626"
